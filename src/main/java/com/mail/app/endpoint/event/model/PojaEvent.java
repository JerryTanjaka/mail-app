...
import static com.mail.app.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.mail.app.PojaGenerated;
import com.mail.app.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.mail.app.event1";
    return "com.mail.app.event2";
  }
}
