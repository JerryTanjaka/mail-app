package com.mail.app.endpoint.event.consumer;

import com.mail.app.PojaGenerated;
import com.mail.app.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.mail.app.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.mail.app.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
